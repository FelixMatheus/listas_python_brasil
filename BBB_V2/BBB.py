...
class Apresentacao(object):
    ...
    evento4 = Eventos("BigFone", "Big Boss", "Evento do Big Fone")
    ...
    week = n-2 #Duracao do Evento mediante ao numero de participantes
    ...
    prov1 = prova1.defineLider_Anjo_Imunizado_Paredao1(listaParticipante)
